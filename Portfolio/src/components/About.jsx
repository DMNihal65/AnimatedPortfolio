...
function About() {
  return (
    <div className='w-full p-32 bg-emerald-700 rounded-t-lg'>
      <h1 className='font-Neuefont text-[2vw] leading-[3.5vw] tracking-tight '>"I'm not just a coder ✨, I'm a tech-wielding alchemist transforming data into dazzling dashboards 📊 and websites 💻. With a dash of creativity and a heaping spoonful of problem-solving , I craft digital experiences that are both beautiful and functional. My journey began with lines of code 💻, but soon blossomed into a passion for design 🎨, weaving user-centric magic ✨ into every pixel."</h1>
